...
- [HRBP_AI_AGENT_COLLABORATION_EXPERIENCE.md](./HRBP_AI_AGENT_COLLABORATION_EXPERIENCE.md)
  HRBP 团队在早期实践中沉淀出的协作经验文档，保留原有框架，并按当前知识库使用方式做了轻量更新。
- [ARCHGUARD_SKILL_METHOD_LESSONS_2026-03-11.md](./ARCHGUARD_SKILL_METHOD_LESSONS_2026-03-11.md)
  以 ArchGuard 为例，展示如何学习外部优秀项目、如何吸收方法、如何把学习过程沉淀成自己的项目方法资产。

## 维护约定

- `README.md` 只负责说明仓库定位和文档导航。
- 协作方法正文放在独立主题文档里，不要把所有经验堆在首页。
